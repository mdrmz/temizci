        ...
        <div class="auth-card">
            ...
            <?php if ($isQuickFlow): ?>
                <div class="flash flash-info">
                    Hızlı talebiniz hazır. Giriş yaptıktan sonra ilan ekranına otomatik yönlendirileceksiniz.
                </div>
            <?php endif; ?>
            ...
            <form id="loginForm" method="POST" action="" data-validate>
                ...
                <button type="submit" class="btn btn-primary btn-block btn-lg" data-track="login_submit_click">Giriş Yap</button>
            </form>
