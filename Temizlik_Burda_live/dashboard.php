...
<head>
    ...
    <title>Panel - Temizci Burada</title>
...
<body>
    <div class="app-layout">
        ...
        <div class="main-content">
            <?php $headerTitle = 'Panel'; include 'includes/app-header.php'; ?>
                    ...
                    <div class="card-body">
                            ...
                            <?php foreach ($chartData as $day): ?>
                                <div style="flex:1;display:flex;flex-direction:column;align-items:center;gap:4px;height:100%;justify-content:flex-end;">
                                    <div style="display:flex;gap:3px;align-items:flex-end;width:100%;justify-content:center;min-height:0;flex:1;">
                                        <div style="width:14px;background:linear-gradient(to top, #0f766e, #14b8a6);border-radius:4px 4px 0 0;height:<?= $maxVal > 0 ? max(4, ($day['listings']/$maxVal)*120) : 4 ?>px;transition:height 0.5s;" title="İlan: <?= $day['listings'] ?>"></div>
                                        <div style="width:14px;background:linear-gradient(to top, #0d9488, #5eead4);border-radius:4px 4px 0 0;height:<?= $maxVal > 0 ? max(4, ($day['offers']/$maxVal)*120) : 4 ?>px;transition:height 0.5s;" title="Teklif: <?= $day['offers'] ?>"></div>
                                    </div>
                        ...
                        <div style="display:flex;justify-content:center;gap:20px;margin-top:14px;">
                            <div style="display:flex;align-items:center;gap:6px;font-size:0.78rem;">
                                <span style="width:10px;height:10px;background:#0f766e;border-radius:3px;display:inline-block;"></span> İlanlarım
                            </div>
                            <div style="display:flex;align-items:center;gap:6px;font-size:0.78rem;">
                                <span style="width:10px;height:10px;background:#0d9488;border-radius:3px;display:inline-block;"></span> Gelen Teklifler
                            </div>
                        </div>
                    </div>
                </div>
