...
if (isset($_GET['delete'])) {
    ...
    setFlash('success', 'Ä°lan iptal edildi.');
...
<head>
    ...
    <title>Ä°lanlarÄ±m  -  Temizci Burada</title>
...
<body>
    <div class="app-layout">
        ...
        <div class="main-content">
            <?php $headerTitle = 'Ä°lanlarÄ±m'; include '../includes/app-header.php'; ?>

            <div class="page-content">
                <?= flashHtml() ?>
                <div class="page-title"> Ä°lanlarÄ±m</div>
                <div class="page-subtitle">OluÅŸturduÄŸunuz tÃ¼m ilanlarÄ± yÃ¶netin</div>
                ...
                <?php if (empty($listings)): ?>
                    <div class="card">
                        <div class="empty-state">
                            ...
                            <p>Ä°lk ilanÄ±nÄ±zÄ± oluÅŸturun ve hizmet teklifleri almaya baÅŸlayÄ±n!</p>
                            <a href="create" class="btn btn-primary btn-lg">+ Ä°lan OluÅŸtur</a>
                        </div>
                    </div>
                <?php else: ?>
                    <div class="card">
                                                ...
                                                <div style="display:flex;gap:6px;">
                                                    ...
                                                    <?php if ($l['status'] === 'open'): ?>
                                                        <a href="my_listings?delete=<?= $l['id'] ?>"
                                                            ...
                                                            data-confirm="Bu ilanÄ± iptal etmek istiyor musunuz?">Ä°ptal</a>
                                                    <?php endif; ?>
                                                </div>
                                            </td>
                                        </tr>
