    ...
    <div class="profile-hero">
        ...
        <div class="profile-name">
            ...
            <?php if ($worker['is_verified']): ?>
                <span title="DoÄŸrulanmÄ±ÅŸ Profil" style="font-size:1.2rem;"></span>
            <?php endif; ?>
        </div>
        <div class="profile-meta">
            <?= $worker['city'] ? ' ' . e($worker['city']) . ' Â· ' : '' ?>
             <?= $memberSince ?>'den beri Ã¼ye Â·
            <?= $worker['role'] === 'worker' ? ' Hizmet Veren' : 'Â  Ev Sahibi' ?>
        </div>
        
        <div class="profile-stats">
            <div class="profile-stat">
                <div class="profile-stat-val"><?= number_format($worker['rating'], 1) ?> Ã¢Â­Â</div>
                <div class="profile-stat-lbl">Puan</div>
            </div>
            <div class="profile-stat">
                <div class="profile-stat-val"><?= $worker['review_count'] ?></div>
                <div class="profile-stat-lbl">DeÄŸerlendirme</div>
            </div>
            <div class="profile-stat">
                <div class="profile-stat-val"><?= $completedJobs ?></div>
                <div class="profile-stat-lbl">Tamamlanan Ä°ÅŸ</div>
            </div>
            <div class="profile-stat">
    ...
    <div class="profile-body">
        ...
        <div class="card mb-4">
            <div class="card-header">
                <div class="card-title"> HakkÄ±nda</div>
            </div>
            <div class="card-body">
        ...
        <div class="card mb-4">
            <div class="card-header">
                <div class="card-title"> MÃ¼sait GÃ¼nler</div>
            </div>
            <div class="card-body">
        ...
        <div class="card">
            <div class="card-header">
                <div class="card-title">Ã¢Â­Â DeÄŸerlendirmeler (<?= count($reviews) ?>)</div>
            </div>
            <?php if (empty($reviews)): ?>
                <div class="empty-state" style="padding:40px;">
                    <div class="empty-state-icon" style="font-size:2.5rem;">Ã¢Â­Â</div>
                    <h3>HenÃ¼z deÄŸerlendirme yok</h3>
                    <p style="color:var(--text-muted);">Bu kullanÄ±cÄ± henÃ¼z deÄŸerlendirilmemiÅŸ.</p>
                </div>
            <?php else: ?>
