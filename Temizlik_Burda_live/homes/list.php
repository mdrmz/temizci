    ...
    <div class="app-layout">
        ...
        <div class="main-content">
            ...
            <div class="page-content">
                <?= flashHtml() ?>
                <div class="page-title"> KayÄ±tlÄ± Evlerim</div>
                <div class="page-subtitle">KayÄ±tlÄ± evlerinizi yÃ¶netin, yeni ilanlar iÃ§in kullanÄ±n</div>

                <?php if (empty($homes)): ?>
                    <div class="card">
                        <div class="empty-state">
                            <div class="empty-state-icon">Â </div>
                            <h3>HenÃ¼z ev eklemediniz</h3>
                            <p>Temizlik ilanÄ± oluÅŸturmak iÃ§in Ã¶nce bir ev eklemeniz gerekiyor.</p>
                            <a href="add" class="btn btn-primary">Â  Ä°lk Evimi Ekle</a>
                        </div>
                    </div>
                <?php else: ?>
                    <div class="grid-3">
                        <?php foreach ($homes as $home): ?>
                            <div class="card">
                                <?php if ($home['photo']): ?>
                                    <img src="<?= UPLOAD_URL . e($home['photo']) ?>" alt="Ev FotoÄŸrafÄ±"
                                ...
                                <div class="card-body">
                                    ...
                                    <div style="display:flex;flex-direction:column;gap:5px;margin-bottom:14px;">
                                        ...
                                        <?php if ($home['has_elevator']): ?>
                                            <div style="font-size:0.78rem;color:var(--secondary);"> AsansÃ¶rlÃ¼</div>
                                        <?php endif; ?>
                                    </div>
                                    <div style="display:flex;gap:8px;flex-wrap:wrap;">
                                        <a href="../listings/create?home_id=<?= $home['id'] ?>"
                                            class="btn btn-primary btn-sm"> Ä°lan OluÅŸtur</a>
                                        <a href="edit?id=<?= $home['id'] ?>" class="btn btn-ghost btn-sm"> DÃ¼zenle</a>
                                        <a href="delete?id=<?= $home['id'] ?>" class="btn btn-danger btn-sm"
                                            data-confirm="Bu evi silmek istediÄŸinizden emin misiniz?"></a>
                                    </div>
                                </div>
                            </div>
                        <?php endforeach; ?>
                        ...
                        <a href="add" class="card"
                            ...
                            <div style="font-size:2.5rem;">Ã¢Ââ€¢</div>
