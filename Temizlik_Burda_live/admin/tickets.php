    ...
    <div class="app-layout">
        ...
        <div class="main-content">
            ...
            <div class="page-content">
                ...
                <div class="page-subtitle">Kullanıcılardan gelen talepleri yönetin.</div>
                ...
                <form method="GET" class="search-bar mt-4">
                    <div class="form-group" style="flex:1;min-width:220px;">
                        ...
                        <select name="status" class="form-control">
                            ...
                            <option value="open" <?= $filterStatus === 'open' ? 'selected' : '' ?>>Açık</option>
                            <option value="in_progress" <?= $filterStatus === 'in_progress' ? 'selected' : '' ?>>İşlemde</option>
                            <option value="closed" <?= $filterStatus === 'closed' ? 'selected' : '' ?>>Kapalı</option>
                        </select>
                    </div>
                    <div class="form-group" style="flex:1;min-width:220px;">
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                <?php if (empty($tickets)): ?>
                                    <tr>
                                        <td colspan="7" class="text-center" style="padding:28px;color:var(--text-muted);">Henüz destek talebi yok.</td>
                                    </tr>
                                <?php endif; ?>
                                <?php foreach ($tickets as $t): ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="ticket_view.php?id=<?= (int) $t['id'] ?>" class="btn btn-primary btn-sm">Yanıtla</a>
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
                            </tbody>
