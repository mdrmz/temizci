...
<div class="sidebar" id="appSidebar">
    ...
    <nav class="sidebar-nav">
        ...
        <a href="users.php" class="sidebar-link <?= $current_page === 'users.php' ? 'active' : '' ?>">
            <span class="icon">US</span> Kullanıcılar
        </a>
        ...
        <a href="/dashboard" class="sidebar-link">
            <span class="icon">AN</span> Siteye Dön
        </a>
    </nav>
    ...
    <div class="sidebar-user">
        ...
        <button class="theme-toggle-btn" id="themeToggle" title="Tema Değiştir" style="width:32px;height:32px;font-size:0.74rem;border-radius:8px;letter-spacing:0.08em;">TM</button>
    </div>
</div>
