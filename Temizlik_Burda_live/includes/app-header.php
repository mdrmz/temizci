...
<div class="app-header">
    <div class="app-header-left">
        <button class="hamburger app-menu-toggle" id="hamburger" type="button" aria-label="Menüyü aç">
            <span></span>
            <span></span>
            <span></span>
        </button>
        ...
        <div class="notif-wrapper">
            ...
            <div class="notif-panel notif-panel-xl" id="notifDropdown">
                <div class="notif-panel-head">
                    ...
                    <button onclick="markAllRead()" id="markAllBtn" class="notif-mark-all">Tümünü Okundu Olarak İşaretle</button>
                </div>
