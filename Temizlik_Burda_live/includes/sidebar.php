...
<div class="sidebar" id="appSidebar">
    ...
    <nav class="sidebar-nav">
        ...
        <a href="<?= $base ?>/dashboard" class="sidebar-link <?= isActive('dashboard.php') ?>">
            <span class="icon" aria-hidden="true">&#128200;</span> Panel
        </a>
        <a href="<?= $base ?>/listings/browse" class="sidebar-link <?= isActive('browse.php') ?>">
            <span class="icon" aria-hidden="true">&#128269;</span> İlanları Gez
        </a>
        ...
        <a href="<?= $base ?>/listings/my_listings" class="sidebar-link <?= isActive('my_listings.php') ?>">
            <span class="icon" aria-hidden="true">&#128221;</span> İlanlarım
        </a>
        <a href="<?= $base ?>/listings/create" class="sidebar-link <?= isActive('create.php') ?>">
            <span class="icon" aria-hidden="true">&#9998;</span> İlan Oluştur
        </a>
        ...
        <a href="<?= $base ?>/messages.php" class="sidebar-link <?= isActive('messages.php') ?>">
            <span class="icon" aria-hidden="true">&#9993;</span> Mesajlarım
        </a>
        ...
        <a href="<?= $base ?>/logout" class="sidebar-link" data-confirm="Çıkış yapmak istediğinize emin misiniz?">
            <span class="icon" aria-hidden="true">&#10162;</span> Çıkış Yap
        </a>
    </nav>
    ...
    <div class="sidebar-user">
        ...
        <button class="theme-toggle-btn sidebar-theme-toggle" id="themeToggle" title="Tema Değiştir">TM</button>
    </div>
</div>
