...
// Verilen teklifler (worker iÃ§in) VEYA alÄ±nan teklifler (homeowner iÃ§in)
if ($user['role'] === 'worker') {
    $stmt = $db->prepare("
        ...
        <div class="main-content">
            ...
            <div class="page-content">
                ...
                <div class="page-title">
                    <?= $isWorker ? 'VerdiÄŸim Teklifler' : 'Ä°lanlarÄ±ma Gelen Teklifler' ?>
                </div>
                ...
                <?php if (empty($offers)): ?>
                    <div class="card">
                        <div class="empty-state">
                            ...
                            <h3>HenÃ¼z
                                <?= $isWorker ? 'teklif vermediniz' : 'teklif almadÄ±nÄ±z' ?>
                            </h3>
                            <p>
                                <?= $isWorker ? 'AÃ§Ä±k ilanlarÄ± inceleyin ve teklif verin.' : 'Ä°lan oluÅŸturun ve teklif almaya baÅŸlayÄ±n.' ?>
                            </p>
                            <a href="<?= $isWorker ? '../listings/browse.php' : '../listings/create.php' ?>"
                                class="btn btn-primary">
                                <?= $isWorker ? ' Ä°lanlarÄ± Gez' : '+ Ä°lan OluÅŸtur' ?>
                            </a>
                        </div>
                    </div>
                <?php else: ?>
                    ...
                    $statusLabels = ['pending' => 'Ã¢ÂÂ³ Bekleyenler', 'accepted' => ' Kabul Edilenler', 'rejected' => ' Reddedilenler'];
                    ?>
                                        ...
                                        <div
                                            ...
                                            <div style="text-align:right;flex-shrink:0;">
                                                ...
                                                <div style="margin-top:8px;">
                                                    <a href="../listings/detail?id=<?= $offer['listing_id'] ?>"
                                                        class="btn btn-ghost btn-sm">Ä°lana Git Ã¢â€ â€™</a>
