...
$sortMap = [
    ...
    'budget_high' => 'l.budget DESC, l.created_at DESC',
    'budget_low' => 'l.budget ASC, l.created_at DESC',
    'offers_high' => 'offer_count DESC, l.created_at DESC',
    'views_high' => 'l.view_count DESC, l.created_at DESC',
];
...
$w = !empty($where) ? implode(' AND ', $where) : '1=1';
